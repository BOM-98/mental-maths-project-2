...
describe("generateNum1 function", function () {
  ...
  testValues.forEach(function (testValue) {
    it("should generate a number within the correct range for addition gameType, Level 1", function () {
      ...
      assert.isAtLeast(
        num1,
        gameLevelSettings[level][0].num1.min,
        "Generated number is not less than minimum"
      );
      assert.isAtMost(
        num1,
        gameLevelSettings[level][0].num1.max,
        "Generated number is not greater than maximum"
      );
    ...
    it("should generate a number within the correct range for subtraction gameType, Level 1", function () {
      ...
      assert.isAtLeast(
        num1,
        gameLevelSettings[level][1].num1.min,
        "Generated number is not less than minimum"
      );
      assert.isAtMost(
        num1,
        gameLevelSettings[level][1].num1.max,
        "Generated number is not greater than maximum"
      );
      assert.isAtLeast(num1, 1, "Generated number is not less than minimum");
      assert.isAtMost(
    ...
    it("should generate a number within the correct range for multiplication gameType, Level 1", function () {
      ...
      assert.isAtLeast(
        num1,
        gameLevelSettings[level][2].num1.min,
        "Generated number is not less than minimum"
      );
      assert.isAtMost(
        num1,
        gameLevelSettings[level][2].num1.max,
        "Generated number is not greater than maximum"
      );
    });
    ...
    it("should generate a number within the correct range for division gameType, Level 1", function () {
      ...
      assert.isAtLeast(
        num1,
        gameLevelSettings[level][3].num1.min,
        "Generated number is not less than minimum"
      );
      assert.isAtMost(
        num1,
        gameLevelSettings[level][3].num1.max,
        "Generated number is not greater than maximum"
      );
    });
